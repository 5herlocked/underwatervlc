...
def log_data():
    global data_points
    for deltaTime, value, voltage in data_points:
...
def interrupt_handler(sig, frame):
    ...
    print("Data points collected: {}".format())
    log_data()
...
def main(argv):
    ...
    global frequency, data_points, output_name
    try:
    ...
    while True:
        data_points.append((time.asctime(), chan.value, chan.voltage))
